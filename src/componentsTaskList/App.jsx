...
const App = () => {
    ...
    const deletTask = taskId => setTasks(prevTasks => prevTasks.filter(({ id }) => id !== taskId));

    const filterTasks = tasks.filter(({ text }) => text.toLowerCase().includes(filter.toLowerCase()));
